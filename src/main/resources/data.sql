...
create table task (id int not null, date_time timestamp, description varchar(255), name varchar(255), status varchar(255), user_id int not null, primary key (id));
insert into  USER_PROFILE(id, first_name, last_name, username) values(1000, 'john', 'doe', 'jdoe');
